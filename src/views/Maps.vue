...
export default {
  data: () => ({}),
  mounted() {
    this.google.maps.event.addDomListener(window, "load", initialise); // Execute our 'initialise' function once the page has loaded.
  },
  methods: {
    initialise: function() {
      ...
      var infowindow = new google.maps.InfoWindow({
        ...
        content:
          "This is <strong>Megamall Penang</strong>, <em>one</em> of shopping centres that has a cinema!" // HTML contents of the InfoWindow
      });
